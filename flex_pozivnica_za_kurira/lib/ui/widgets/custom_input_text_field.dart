  ...
  CustomInputTextField(
      {
        ...
        this.controllerDeliveryBuyOut,
        this.controllerDeliveryValue,
          ...
          Container(
            ...
            child: TextField(
              ...
              onSubmitted: (String value){
                widget.controllerDeliveryValue?.text = "${widget.controllerDeliveryValue?.text}.00 RSD";
                widget.controllerDeliveryBuyOut?.text = "${widget.controllerDeliveryBuyOut?.text}.00 RSD";
              ...
              ]  : widget.isForPhone ? [FilteringTextInputFormatter.allow(RegExp(r'^\d+\d{0}')),] : List.empty(),
